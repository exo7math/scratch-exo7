...
# Exemple
print("César 1 : ",cesar_bis("ALLEZ ASTERIX",3))

# Exemple
print("César 2 : ",cesar_bis("ADA LOVELACE",3))

# Exemple
print("César 3 : ",cesar_bis("MACHINE MECANIQUE",10))

# Exemple
print("César 4 : ",cesar_bis("GEORGE BOOLE",13))


# Attaque par fréquence
print("Fréquence 1 : ",cesar_bis("ETRE OU NE PAS ETRE",9))

print("Fréquence 2 : ",cesar_bis("SUR LES EPAULES DES GEANTS",11))

print("Fréquence 3 : ",cesar_bis("MOINS GRAND ET PLUS INTELLIGENT",4))
